...
public interface ForumPageDao {
    @Select("select `user`.name as author,`user`.identity,forum_page.id,forum_page.preface,forum_page.topic,forum_page.time,forum_page.title from user,forum_page where `user`.id=forum_page.userId order by time desc")
